...
@implementation WLFollowedUsersRequest

- (id)initFollowedUsersRequestWithUid:(NSString *)uid
{
    return [super initWithType:AFHttpOperationTypeNormal api:[NSString stringWithFormat:@"feed/user/%@/followed-users", uid] method:AFHttpOperationMethodGET];
}
