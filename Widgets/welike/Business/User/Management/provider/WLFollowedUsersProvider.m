...
#import "WLFollowedUsersRequest.h"
#import "WLUsersProviderDelegate.h"

@interface WLFollowedUsersProvider ()

@property (nonatomic, strong) WLFollowedUsersRequest *usersRequest;
...
@implementation WLFollowedUsersProvider
...
- (void)tryRefreshUsersWithKeyId:(NSString *)kid
{
    ...
    self.usersRequest = [[WLFollowedUsersRequest alloc] initFollowedUsersRequestWithUid:kid];
