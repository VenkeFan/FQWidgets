...
@interface WLUserLikePostsProvider ()

@property (nonatomic, copy) NSString *uid;
@property (nonatomic, strong) WLUserLikePostsRequest *feedsRequest;
@property (nonatomic, copy) NSString *cursor;
@property (nonatomic, weak) id<WLFeedsProviderDelegate> delegate;

@end

@implementation WLUserLikePostsProvider
...
- (void)tryRefreshFeeds
{
    ...
    self.feedsRequest = [[WLUserLikePostsRequest alloc] initUserLikePostsRequestWithUid:self.uid];
