...
@interface WLForwardPostsProvider ()

@property (nonatomic, copy) NSString *pid;
@property (nonatomic, strong) WLForwardPostsRequest *feedsRequest;
@property (nonatomic, copy) NSString *cursor;
@property (nonatomic, weak) id<WLFeedsProviderDelegate> delegate;

@end

@implementation WLForwardPostsProvider
...
- (void)tryRefreshFeeds
{
    ...
    self.feedsRequest = [[WLForwardPostsRequest alloc] initForwardPostsRequestWithPid:self.pid];
