//
//  WLLatestLocationFeedsTableView.m
//  welike
//
...
@interface WLLatestLocationFeedsTableView () <UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong, readwrite) WLFeedTableView *tableView;

@end

@implementation WLLatestLocationFeedsTableView
